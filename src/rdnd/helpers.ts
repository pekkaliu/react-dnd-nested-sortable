...
export const reorderChildren = (children:any, splitDropZonePath:any, splitItemPath:any) => {
...
export const addChildToChildren = (children:any, splitDropZonePath:any, item:any) => {
  if (splitDropZonePath.length === 1) {
    const dropZoneIndex = Number(splitDropZonePath[0]);
